          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-gray-700 dark:text-gray-300 px-4">
                To create a new booking, navigate to the "Bookings" tab in your
                dashboard and click on the "New Booking" button. Fill in the
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="text-gray-700 dark:text-gray-300 px-4">
                ...
                "Profile" section in your dashboard. Click on the "Edit" button,
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="text-gray-700 dark:text-gray-300 px-4">
                You can connect with our customer support team by submitting a
                query using the form above or by emailing us at
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="text-gray-700 dark:text-gray-300 px-4">
                We support all major payment methods, including credit/debit
                cards, PayPal, and bank transfers. You can manage your payment
                methods in the "Payments" section.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent className="text-gray-700 dark:text-gray-300 px-4">
                To cancel a booking, go to the "Bookings" tab, find the booking
                you want to cancel, and click on the "Cancel" button. Provide a
                reason for cancellation and confirm.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
